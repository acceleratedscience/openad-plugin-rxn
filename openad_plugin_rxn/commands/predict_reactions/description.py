...
Use <cmd>predict topn reactions</cmd> to fetch the top-5 predictions for each reaction, or set the <cmd>topn</cmd> parameter to a different value.
...
<cmd>topn=<int></cmd>
    ...
    When not set, only one result will be returned, unless when using <cmd>predict topn reactions</cmd>, this will default to 5.
